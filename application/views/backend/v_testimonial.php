...
<html>
    <head>
        ...
        <meta name="author" content="Informatika Universitas Siliwangi" />
        <link rel="shortcut icon" href="<?php echo base_url().'assets/images/SGR.png'?>">
        <!-- Styles -->
        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner">
                    ...
                    <div class="logo-box">
                        <a href="<?php echo site_url('backend/dashboard');?>" class="logo-text"><span>SIGERI</span></a>
                    </div><!-- Logo Box -->
            ...
            <div class="page-inner">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    ...
                                                    <?php else:?>
                                                    <img class="img-circle" width="50" height src="<?php echo base_url().'assets/images/'.$row->testimonial_image;?>">
                                                    <?php endif;?>
                                                </td>
                ...
                <div class="page-footer">
                    <p class="no-s">&copy; <?php echo date('Y');?> Informatika Universitas Siliwangi</p>
                </div>
            </div><!-- Page Inner -->
        </main><!-- Page Content -->
