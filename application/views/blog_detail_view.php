						...
						<div class="row">
							<div class="col-md-8 col-md-offset-2">
								...
								<div class="blog-item clearfix">						
									...
									<!-- Awal API MAP DESA WISATA SUKAIMUT -->
									<h2 class="text-center"><b>Peta Desa Wisata Sukaimut</b></h2>
									<div id="map"></div>
									<script>
									    let map;
									    ...
									    function initMap() {
									        const mapOptions = {
									          zoom: 15,
									          center: { lat: -7.0095472318044605, lng: 108.54539196529315 },

									        };
									        map = new google.maps.Map(document.getElementById("map"), mapOptions);

									        addMarker({ lat: -7.004324802602054, lng: 108.54652655394217 });
									        addMarker({ lat: -7.015073835122128, lng: 108.54645234459635 });
									...
									<!-- Akhir API MAP DESA WISATA SUKAIMUT -->
